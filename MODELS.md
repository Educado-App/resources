...
| coverImg | `String` | The&nbsp;image&nbsp;shown&nbsp;with the course when using the grid view |✔|| <div style="text-align:center;font-size:40px"> An `String` made up of the course "id" followed coures or lecture indicator ("_c" or "_l"). </div>
